...
namespace assignment1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string name, string password, int score) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int score {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'score\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsscoreNull() {
                return this.IsNull(this.tableTable.scoreColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetscoreNull() {
                this[this.tableTable.scoreColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace assignment1.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([name] = @Original_na" +
                "me) AND ([password] = @Original_password) AND ((@IsNull_score = 1 AND [score] IS" +
                " NULL) OR ([score] = @Original_score)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([name], [password], [score]) VALUES (@name, @password," +
                " @score);\r\nSELECT Id, name, password, score FROM [Table] WHERE (Id = SCOPE_IDENT" +
                "ITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [name] = @name, [password] = @password, [score] = @score WHERE (([Id] = @Original_Id) AND ([name] = @Original_name) AND ([password] = @Original_password) AND ((@IsNull_score = 1 AND [score] IS NULL) OR ([score] = @Original_score)));
SELECT Id, name, password, score FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::assignment1.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, password, score FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_password, global::System.Nullable<int> Original_score) {
        ...
        public virtual int Insert(string name, string password, global::System.Nullable<int> score) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string password, global::System.Nullable<int> score, int Original_Id, string Original_name, string Original_password, global::System.Nullable<int> Original_score, int Id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string password, global::System.Nullable<int> score, int Original_Id, string Original_name, string Original_password, global::System.Nullable<int> Original_score) {
            return this.Update(name, password, score, Original_Id, Original_name, Original_password, Original_score, Original_Id);
        }
    }
